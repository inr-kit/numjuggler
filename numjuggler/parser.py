...
class Card(object):
    ...
    #     """
    #     Wrapper around original card() that removes all tokens with '___' and
    #     removes in-card empty lines.
    #     """
    #     c = self._card(wrap, comment)

    #     # remove '___' places:
    #     r = re.compile(' [^ ]*___')
    #     c = ' '.join(r.split(c)) # TODO will not work for "u = ___"

    #     # remove in-card empty lines:
    #     res = []
